...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if isinstance(insect, QueenAnt) and not insect.not_first_queen:
                return None
            # END Problem 13
...
class Insect(object):
    ...
    def __init__(self, armor, place=None):
        ...
        self.bee_has_scared = False
        self.bee_dir_left = True
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        min_place = self.min_range
        while start_point_counter<self.min_range:
            current_place = current_place.entrance
            start_point_counter+=1
        while current_place is not hive and current_place.bees == []:
            if min_place<self.max_range:
                current_place = current_place.entrance
                min_place += 1
            else:
                break
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        "*** YOUR CODE HERE ***"
        Insect.__init__(self, armor)
        self.not_first_queen = QueenAnt.not_first_queen
        QueenAnt.not_first_queen = True
        self.double_damaged_ants =[]
    ...
    def action(self, colony):
        ...
        if self.not_first_queen:
            ...
            while current_place is not None:
                ...
                if current_ant != None and current_ant not in self.double_damaged_ants:
                    current_ant.damage = current_ant.damage*2
                    self.double_damaged_ants.append(current_ant)

                if isinstance(current_ant, BodyguardAnt) and current_ant.contained_ant and current_ant.contained_ant not in self.double_damaged_ants:
                    current_ant.contained_ant.damage = current_ant.contained_ant.damage *2
                    self.double_damaged_ants.append(current_ant.contained_ant)
...
def make_scare(action, bee):
    ...
    "*** YOUR CODE HERE ***"
    def new_action(colony):
        bee.bee_dir_left = False
        action(colony)
        bee.bee_dir_left = True
    return new_action
...
def apply_effect(effect, bee, duration):
    ...
    # BEGIN Problem EC
    "*** YOUR CODE HERE ***"
    #if bee.bee_has_scared and effect is make_scare:
        #return None
    bee_original_action = bee.action
    bee_new_action = effect(bee.action, bee)
    x = duration
    def new_action(colony):
        nonlocal x
        if x > 0:
            x -= 1
            return bee_new_action(colony)
        else:
            return bee_original_action(colony)
...
class ScaryThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        # BEGIN Problem EC
        if target and not target.bee_has_scared:
            target.bee_has_scared = True
